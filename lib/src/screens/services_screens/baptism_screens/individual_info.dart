...
* Created			: 2019-06-13 18:42:08 by Scarlet Witch
*	Updated			:	2019-06-13 18:42:08 by Scarlet Witch 
*	Changes			:
*/

import 'package:flutter/material.dart';
import 'package:mt_carmel_app/src/constants/app_constants.dart';
import 'package:mt_carmel_app/src/screens/services_screens/baptism_screens/individual_form.dart';
        ...
        child: Column(
          ...
          Expanded(
              child: SingleChildScrollView(
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("Panyal, Certificate, Candle for the Parents, 2 Candles in glass for the Sponsors (candles for additional sponsors are not included)", 
                  style: AppConstants.OPTION_STYLE2,
                  ),
                ),
                SizedBox(height: 10.0),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("300 php", style: AppConstants.OPTION_STYLE2,),
                ),
                SizedBox(height: 10.0),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("Reservation Fee (deductible)", 
                  style: AppConstants.OPTION_STYLE2,
                  ),
                ),
                SizedBox(height: 10.0),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("2,000 php", style: AppConstants.OPTION_STYLE2,),
                ),
                SizedBox(height: 10.0),
                Text("Baptism will be held in Pilgrim Chapel, St. Joseph Bldg.", 
                style: AppConstants.OPTION_STYLE2,
                textAlign: TextAlign.left,), 
                SizedBox(height: 10.0),  
