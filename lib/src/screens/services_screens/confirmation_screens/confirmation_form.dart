...
* Created			: 2019-06-13 15:41:26 by Scarlet Witch
*	Updated			:	2019-06-13 15:41:26 by Scarlet Witch 
        ...
        Expanded(
          child: SingleChildScrollView(
            ...
            Container(
              margin: EdgeInsets.only(left: 30.0, right: 30),
              child: Column(children: <Widget>[
                Text("Date of Baptism", style: AppConstants.OPTION_STYLE2),
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 10.0),
                  child: TextField(
                    textAlign: TextAlign.center,
            ...
            Container(
              margin: EdgeInsets.only(left: 30.0, right: 30),
              child: Column(children: <Widget>[
                Text("Church of Baptism", style: AppConstants.OPTION_STYLE2),
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 10.0),
                  child: TextField(
                    textAlign: TextAlign.center,
            ...
            Container(
              margin: EdgeInsets.only(left: 30.0, right: 30),
              child: Column(children: <Widget>[
                Text("Name of Father", style: AppConstants.OPTION_STYLE2),
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 10.0),
                  child: TextField(
                    textAlign: TextAlign.center,
            ...
            Container(
              margin: EdgeInsets.only(left: 30.0, right: 30),
              child: Column(children: <Widget>[
                Text("Name of Mother", style: AppConstants.OPTION_STYLE2),
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 10.0),
                  child: TextField(
                    textAlign: TextAlign.center,
