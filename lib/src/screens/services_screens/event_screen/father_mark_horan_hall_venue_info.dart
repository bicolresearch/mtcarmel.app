...
* Created			: 2019-06-13 15:15:58 by Scarlet Witch
*	Updated			:	2019-06-13 15:15:58 by Scarlet Witch 
          ...
          Expanded(
              child: SingleChildScrollView(
                ...
                Padding(
                  ...
                  child: Text("300 tiffany chairs", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("30 tables", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("30,000 php", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("2,000 php/excess hour", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                SizedBox(height: 10.0),
                ...
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("300 monoblock chairs", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                ...
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("27,500 php", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                ...
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("120 tiffany chairs", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("12 tables", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("23,000 php", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("1,000 php/excess hour", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                SizedBox(height: 10.0),
                ...
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("120 monoblock chairs", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                ...
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("20,000 php", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                ...
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("80 tiffany chairs", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("8 tables", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("15,000 php", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("500 php/excess hour", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                SizedBox(height: 10.0),
                ...
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("80 monoblock chairs", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                ...
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text("10,000 php", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("b. In the event wherein the client requests for a transfer of his/her reservation to another date or transfer his/her reservation to a member of his/her family, the client is requested to submit a letter of intent addressed to the superior of the shrine. If the superior allows the trasfer, the client will be charged for an additional 50% of the down payment made on his/her previous reservation as penalty.", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                SizedBox(height: 10.0),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("b. Clients may bring their own sound system but no fees will be deducted from the contract package. Live band may be allowed but without drums.", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                SizedBox(height: 10.0),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("b. The management shall be free from any legal suit and liability with regards to the services rendered by the catering service provider, including issues such as food poisoning and sanitation.", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                SizedBox(height: 10.0),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("b. Use of kerosene or gas torch is strictly prohibited inside Father Mark Horan Hall.", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("c. Swag and drape clothing are strictly prohibited.", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("d. Party poppers are not allowed inside the Father Mark Horan Hall.", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("e. Clients are allowed to bring a maximum of 6 cases of liquor such as Pale Pilsen, Red Horse, San Mig Light,or the same kind only.", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
                SizedBox(height: 10.0),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("b. The client's event coordinator must abide with all the rules and regulations. They shall inform the mamagement for any requests 2 weeks prior to the event. Any such requests may be declined without necessity of explanation.", style: Theme.of(context)
                      .primaryTextTheme
                      .subhead,),
                ),
            ],
