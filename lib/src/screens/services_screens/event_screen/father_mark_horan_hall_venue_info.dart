      ...
      body: Container(
        ...
        child: Column(
          ...
          Expanded(
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("b. Client are given a maximum of 3 hours for the use of the Father Mark Horan Hall. Set up time is only 2 hours before the actual time of event.", style: AppConstants.OPTION_STYLE2,),
              ),
              SizedBox(height: 10.0),
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("b. All fees should be settled 2 weeks beforethe event. Booking 1 week prior to the event, payment must be in full.", style: AppConstants.OPTION_STYLE2,),
              ),
              SizedBox(height: 10.0),
              ...
              SizedBox(height: 10.0),
              Text("All aeras include the use of air conditioner, built-in sound system, ample parking space, clean toilet, LCD projector, and electricity for photo booth and maximum of food carts.", 
              style: AppConstants.OPTION_STYLE2,
              textAlign: TextAlign.left,), 
              SizedBox(height: 10.0),
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("a. The client has the full responsibility toward the safety an security of their guests.", 
                style: AppConstants.OPTION_STYLE2,
                ),
              ),
              Padding(
