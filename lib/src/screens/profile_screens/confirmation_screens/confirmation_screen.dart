/*
*   Filename    :   confirmation_screen.dart
*   Purpose     :
...
import 'package:mt_carmel_app/src/screens/profile_screens/confirmation_screens/confirmation_detail_screen.dart';
...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  List<Confirmation> _moduleModels = [];
  ...
  Widget _moduleModelItem(BuildContext context, int index) {
    final Confirmation confirmation = _moduleAndDataActions.modules[index];
    if (confirmation.statusName == "On-going") {
      return Dismissible(
        key: Key(confirmation.id),
        child: InkWell(
          child: Container(
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => MultiProvider(
                  ...
                  child: ConfirmationDetailScreen(),
                ),
              ),
            );
          },
  ...
  _updateRequest(Confirmation confirmation, remarks) async {
    final userId =
...
//    id, status_id, remarks, user_id
    ...
    final url =
        "${AppConstants.API_BASE_URL}${ModuleDirectories.MASS_REQUEST_DIR.split("/")[0]}/update/id/${confirmation.id}/role_id/$roleId";
...
//                onChanged: (_){},
  ...
  void _initialize() {
    _moduleAndDataActions =
        BlocProvider.of<ConfirmationBloc>(context).moduleAndDataActions;
