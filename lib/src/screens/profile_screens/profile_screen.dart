          ...
          child: Padding(
            ...
            child: Column(
              ...
              Container(
                ...
                child: Icon(MountCarmelIcons.logo, color: Colors.brown, size: 100,)
                ),
               SizedBox(
                 height: 10.0,
               ),
  ...
  Widget _userHeader(){
    return Container(
        ...
        child: Row(children: <Widget>[
          Image.asset("assets/images/sample_user.png",),
          Container(
                ...
                Container(
                  child: Expanded(
                    child: Row(children: <Widget>[
                      ...
                      GestureDetector(
                        child: Icon(MountCarmelIcons.settings,
                        color: Colors.brown,)
                        )
                      ],
                    ),
