        ...
        home: 
          Stack(
            ...
            Container(
              ...
              child: 
              Container(
                child: adList.isNotEmpty&&!isLoading
                  ?ads()
                  :Container(),
  ...
  Container ads(){
    ...
    return Container(
      child: Stack(children: <Widget>[
        //line
        lineWidget(),
          Container(child:adContainer, padding: EdgeInsets.only(top: 20.0),),
          Align(
            alignment: Alignment.topCenter,
              ...
              child: Material(
                  ...
                  style: TextStyle(color: Colors.brown, fontFamily: "Helvetica", fontSize: 12.0, )),
              ),
