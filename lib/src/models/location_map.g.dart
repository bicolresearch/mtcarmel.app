...
MapCoordinate _$MapCoordinateFromJson(Map<String, dynamic> json) {
  return MapCoordinate(json['id'] as String, json['branch_id'] as String,
...
MapCenter _$MapCenterFromJson(Map<String, dynamic> json) {
  return MapCenter(json['id'] as String, json['branch_id'] as String,
      json['lat_center'] as String, json['lng_center'] as String);
}
