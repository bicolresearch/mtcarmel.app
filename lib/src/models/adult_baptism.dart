/*
*   Filename    :   adult_baptism.dart
*   Purpose     :
*   Created     :   07/12/2019 2:00 PM by Detective Conan
*   Updated     :   07/12/2019 2:00 PM by Detective Conan
*   Changes     :   
*/

import 'package:json_annotation/json_annotation.dart';

part 'adult_baptism.g.dart';
...
class AdultBaptism {
  ...
  factory AdultBaptism.fromJson(Map<String, dynamic> json) =>
      _$AdultBaptismFromJson(json);

  Map<String, dynamic> toJson() => _$AdultBaptismToJson(this);
}
