...
class ApplicationService {
  Future<ModuleAndDataActions> getModuleAndDataActions() async {
    ...
    try {
      _dataActionModuleModel = await locator<ModuleModelService>()
          .getDataActionModuleModels(
              ModuleDirectories.APPLICATION_DIR.split("/")[0]);
    } catch (e) {
      print(e);
    }
    ...
    final urlByIdBase =
        "${AppConstants.API_BASE_URL}${ModuleDirectories.APPLICATION_DIR}/?branch_id=$branchId&role_id=$roleId&id=";
      ...
      for (var moduleModel in moduleModels) {
        ...
        await client.get('$urlByIdBase$id').then((respond) {
          if (respond.statusCode == 200) {
            ...
            final application = Application.fromJson(body);
    ...
    return ModuleAndDataActions(_applications, _dataActionModuleModel);
  }
}
