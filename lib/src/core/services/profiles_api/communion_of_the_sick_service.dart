/*
*   Filename    :   communion_of_the_sick_service.dart
*   Purpose     :
*   Created     :   28/11/2019 1:55 PM by Detective Conan
*   Updated     :   28/11/2019 1:55 PM by Detective Conan
*   Changes     :   
*/
...
class CommunionOfTheSickService {
  Future<ModuleAndDataActions> getModuleAndDataActions() async {
    List<CommunionOfTheSick> _communionOfTheSicks = [];
    ...
    final urlByIdBase =
        "${AppConstants.API_BASE_URL}${ModuleDirectories.COMMUNION_OF_THE_SICK_DIR}/?branch_id=$branchId&role_id=$roleId&id=";
      ...
      for (var moduleModel in moduleModels) {
        ...
        await client.get('$urlByIdBase$id').then((respond) {
          if (respond.statusCode == 200) {
            ...
            final communionOfTheSick = CommunionOfTheSick.fromJson(body);
            _communionOfTheSicks.add(communionOfTheSick);
          }
        });
      }
    } finally {
    ...
    return ModuleAndDataActions(_communionOfTheSicks, _dataActionModuleModel);
  }
}
