/*
*   Filename    :   community_baptism_service.dart
*   Purpose     :
*   Created     :   28/11/2019 1:54 PM by Detective Conan
*   Updated     :   28/11/2019 1:54 PM by Detective Conan
*   Changes     :   
*/
...
class CommunityBaptismService {
  Future<ModuleAndDataActions> getModuleAndDataActions() async {
    List<CommunityBaptism> _communityBaptisms = [];
    ...
    final urlByIdBase =
        "${AppConstants.API_BASE_URL}${ModuleDirectories.COMMUNITY_BAPTISM_DIR}/?branch_id=$branchId&role_id=$roleId&id=";
      ...
      for (var moduleModel in moduleModels) {
        ...
        await client.get('$urlByIdBase$id').then((respond) {
          if (respond.statusCode == 200) {
            ...
            final communityBaptism = CommunityBaptism.fromJson(body);
            _communityBaptisms.add(communityBaptism);
          }
        });
      }
    } finally {
    ...
    return ModuleAndDataActions(_communityBaptisms, _dataActionModuleModel);
  }
}
