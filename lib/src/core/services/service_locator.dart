...
//  locator.registerLazySingleton(() => TransparencyService());
  ...
  locator.registerLazySingleton(() => AdultBaptismService());
  locator.registerLazySingleton(() => CommunityBaptismService());
  locator.registerLazySingleton(() => ConfirmationService());
  locator.registerLazySingleton(() => CryptLobbyService());
  locator.registerLazySingleton(() => FirstCommunionService());
  locator.registerLazySingleton(() => FmhHallService());
  locator.registerLazySingleton(() => FuneralChapelService());
